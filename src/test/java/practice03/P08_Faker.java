...
public class P08_Faker extends TestBase {
     ...
     */
        ...
        form.sendKeys(faker.name().firstName(), Keys.TAB,faker.name().lastName(),Keys.TAB,
        ...
        String ortaYol = "C:\\Users\\Toprak Gezi\\Desktop\\sen.txt";
        String dosyaYolu = anaYol+ortaYol;
   ...
   //     driver.findElement(By.xpath("//*[@class='subjects-auto-complete__control css-yk16xz-control']")).sendKeys("Arts");
